...
--
-- Host: localhost
-- Generation Time: Apr 28, 2010 at 04:08 PM
...
--
-- Dumping data for table `adv_text`
--
...
('normal', 'all', 1, 'encode_h263', 'standard', 'both', 630, 473, 600, 'fix', 640, 480, 1, 0, 44100, 128, '', 'flv'),
('normal', 'all', 2, 'encode_x264', 'standard', 'both', 960, 720, 1500, 'standard', 1280, 720, 2, 0, 48000, 256, '', 'mp4'),
('normal', 'all', 3, 'encode_ipod', 'standard', 'both', 480, 320, 750, 'standard', 1280, 720, 1, 1, 44100, 128, '', 'mp4');
...
--
-- Dumping data for table `game_favorites`
--
...
--
-- Dumping data for table `game_rating_id`
--
...
--
-- Dumping data for table `game_rating_ip`
--
...
--
-- Dumping data for table `photo_rating_id`
--
...
--
-- Dumping data for table `photo_rating_ip`
--
...
--
-- Dumping data for table `users_rating_id`
--
...
--
-- Dumping data for table `users_rating_ip`
--
...
--
-- Dumping data for table `video_subscribe`
--
...
--
-- Dumping data for table `video_vote_ip`
--
...
--
-- Dumping data for table `video_vote_users`
--
